...
import org.team.voided.voidlib.wfc.command.WaveFunctionArgumentType
import org.team.voided.voidlib.wfc.data.JsonType
import org.team.voided.voidlib.wfc.data.loader.WFCLoaders
import org.team.voided.voidlib.wfc.wave.Tiles
...
class WFC: LibModule("wfc") {
    ...
    override fun commonSetup() {
        ...
        WFCRegistries.registerTileGenerationRuleType(id("limited_placement"), LIMITED_PLACEMENT_TYPE)
