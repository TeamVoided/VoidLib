...
object Packets {
    fun <PacketData> sendToClient(
        ...
        packet: S2CVoidPacket<PacketData>,
        data: PacketData
    ) {
    ...
    fun <PacketData> sendToClient(
        player: ServerPlayerEntity,
        packet: ChainS2CVoidPacket<PacketData>,
        data: PacketData
    ) {
        val buf = createBuffer()
        packet.encode(buf, data)
    ...
    fun <PacketData> sendToServer(
        chainId: Identifier,
        packet: C2SVoidPacket<PacketData>,
        data: PacketData
    ) {
    ...
    fun <PacketData> ChainS2CVoidPacket<PacketData>.sendToClient(
        player: ServerPlayerEntity,
        data: PacketData
    ) = sendToClient(player, this, data)

    fun <PacketData> C2SVoidPacket<PacketData>.sendToServer(
        chainId: Identifier,
        data: PacketData
    ) = sendToServer(chainId, this, data)

    fun <PacketData> ChainC2SVoidPacket<PacketData>.sendToServer(
        data: PacketData
    ) = sendToServer(this, data)

    fun <PacketData> openChainClient(
        chain: Chain, packet: S2CVoidPacket<PacketData>
    ) {
    ...
    fun <PacketData> openChainServer(
        chain: Chain, packet: C2SVoidPacket<PacketData>
    ) {
    ...
    fun <PacketData> Chain.open(packet: S2CVoidPacket<PacketData>) =
